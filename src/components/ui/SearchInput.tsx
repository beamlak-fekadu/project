  ...
  return (
    <div className="relative min-w-0 w-full max-w-sm">
      ...
      <input
        ...
        className="block w-full rounded-lg border border-[var(--border-subtle)] bg-[var(--surface-1)] py-2 pl-10 pr-8 text-sm text-[var(--foreground)] shadow-sm transition-colors placeholder:text-[var(--text-subtle)] focus:border-[var(--brand)] focus:outline-none focus:ring-2 focus:ring-[var(--brand-soft)]"
      />
      {displayValue && (
        <button
